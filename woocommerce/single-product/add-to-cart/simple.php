...
if ($product->is_in_stock()) : ?>
  ...
  <form class="cart mz-w-full" action="<?php echo esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())); ?>" method="post" enctype='multipart/form-data'>
    ...
    <div class="mz-relative">
      <div class="mz-grid lg:mz-grid-cols-[150px,1fr] mz-place-items-center mz-items-center mz-gap-4 ">

        <?php do_action('woocommerce_before_add_to_cart_button'); ?>

        <div class="mz-flex mz-max-w-[150px] mz-mx-auto mz-border mz-border-gray-200  mz-overflow-hidden">
          <button type="button"
          ...
          <div class="mz-w-16 mz-h-12 mz-flex mz-items-center mz-justify-center mz-border-l mz-border-r mz-border-gray-200">
            <?php
        ...
        <button type="submit"
          ...
          class="single_add_to_cart_button button alt mz-h-12 mz-px-10 mz-flex mz-max-w-[250px] mz-w-full  mz-justify-center mz-bg-green-500 hover:mz-bg-green-600 mz-text-white mz-font-semibold mz-rounded-md">
